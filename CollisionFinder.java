...
public class CollisionFinder extends Thread{
	...
	public static void main(String[] args) {
		...
		(new CollisionFinder()).start();	// begin run-time-check thread
	...
	public static long performSingleTest() {
		...
		long i = 0;
		while (true) {
			String message = new StringGenerator(getRandomNumberInRange(random, 1, 100), random).nextString();
			byte[] h = hash(message);
	...
	/*
	 * Prints the bytes in 2 byte pairs
	 */
	...
	/*
	 * Hashes the message and returns the encrypted message
	 */
